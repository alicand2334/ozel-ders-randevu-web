-- |--------------------------------------------------------------------------
-- Migration: 0039_appointments_delete_guard_teacher_bypass.sql
-- Açıklama: appointments_delete_guard fonksiyonunu güncelle ki öğretmen
--           kendi availability'sindeki pending randevuları silebilsin.
--           appointments.teacher_id kolonunu kullan (availability lookup gerekmez).
-- ---------------------------------------------------------------------------
